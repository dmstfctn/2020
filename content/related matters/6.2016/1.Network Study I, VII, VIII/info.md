...
NETWORK STUDY I, Ⅶ & Ⅷ are audiovisual works exploring urban network infrastructure. Each reproduces wireless network activity captured using custom hardware and software as sound, text, pictograms and warping satellite imagery.
...
<span class="dc-hide-on-small">These are included in SELECTED NETWORK STUDIES (<a href="https://networkensemble.bandcamp.com/merch/selected-network-studies-2gb-sd-card" target="_blank">NUKFM</a>, 2016).</span>